...
#include <memory>
#include "../../one_card/loginwidget.h"
...
QT_MOC_LITERAL(3, 25, 15), // "recharge_signal"
QT_MOC_LITERAL(4, 41, 15) // "password_signal"

    },
    "LoginWidget\0back_signal\0\0recharge_signal\0"
    "password_signal"
};
...
void LoginWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->recharge_signal(); break;
        case 2: _t->password_signal(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LoginWidget::back_signal)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (LoginWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LoginWidget::recharge_signal)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (LoginWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LoginWidget::password_signal)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void LoginWidget::back_signal()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void LoginWidget::recharge_signal()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void LoginWidget::password_signal()
{
