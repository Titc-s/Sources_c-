...
#include <memory>
#include "../../one_card/registerwidget.h"
...
QT_MOC_LITERAL(1, 15, 11), // "back_signal"
QT_MOC_LITERAL(2, 27, 0) // ""

    },
    "registerwidget\0back_signal\0"
};
...
void registerwidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&registerwidget::back_signal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void registerwidget::back_signal()
{
